...
public class SimpleControl : MonoBehaviour {
    ...
    void Start () {
        ...
        //создание     лабиринта            Пока не надо, создаю вручную
      /*  var wall1 = GameObject.CreatePrimitive(PrimitiveType.Cube);
        wall1.transform.position =  new Vector3(4, 2, 60);
        wall1.transform.localScale = new Vector3(11, 5, 1);
        */
/*

        //forward sensor

        var ForwardRangeSensor = gameObject.AddComponent<CapsuleCollider>();
        ForwardRangeSensor.isTrigger = true;
        ForwardRangeSensor.center = new Vector3(0, 3, 4);
        ForwardRangeSensor.radius = 1;
        ForwardRangeSensor.height = 1;

        // back sensor

        var BackRangeSensor = gameObject.AddComponent<CapsuleCollider>();
        BackRangeSensor.isTrigger = true;
        BackRangeSensor.center = new Vector3(0, 3, -4);
        BackRangeSensor.radius = 1;
        BackRangeSensor.height = 1;


        // right sensor

        var RightRangeSensor = gameObject.AddComponent<CapsuleCollider>();
        RightRangeSensor.isTrigger = true;
        RightRangeSensor.center = new Vector3(4, 3, 0);
        RightRangeSensor.radius = 1;
        RightRangeSensor.height = 1;
        ...
        var LeftRangeSensor = gameObject.AddComponent<CapsuleCollider>();
        LeftRangeSensor.isTrigger = true;
        LeftRangeSensor.center = new Vector3(-4, 3, 0);
        LeftRangeSensor.radius = 1;
        LeftRangeSensor.height = 1;
        LeftRangeSensor.name = "left";


        ЭТА ХУЙНЯ НЕ РАБОТАЕТ НУЖНО ИСПОЛЬЗОВАТЬ RAYCAST
    */
